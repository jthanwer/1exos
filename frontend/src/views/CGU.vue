    ...
    <div class="container">
      <div class="content">
        ...
        <p>
          ...
          conditions dans lesquelles d’une part, Rémi Thanwerdas, ci-après
          dénommé l’EDITEUR, met à la disposition de ses utilisateurs le site,
          et les services disponibles sur le site et d’autre part, la manière
          par laquelle l’utilisateur accède au site et utilise ses services.
        </p>
        <p>
        ...
        <p>
          Pour l’utilisateur, <span class="s-t">l’utilisation du</span> site de
          l’EDITEUR à l’adresse URL suivante
          <a href="http://www.1exo.fr/"><span class="s-t">www.1exo.fr</span></a
          ><span class="s-t"> </span>implique l’acceptation de l’ensemble des
          conditions décrites ci-après.
        </p>
        <h2 class="subtitle has-text-tertiary is-3">
          Propriété intellectuelle
        </h2>
        <p>
          La structure générale du site
          <a href="http://www.1exo.fr/"><span class="s-t">www.1exo.fr</span></a
          >, ainsi que les textes, graphiques, images, sons et &nbsp;vidéos la
          composant, sont la propriété de l'éditeur ou de ses partenaires. Toute
          représentation et/ou reproduction et/ou exploitation partielle ou
          totale des contenus et services proposés par le site
          <a href="http://www.1exo.fr/"><span class="s-t">www.1exo.fr</span></a
          >, par quelque procédé que ce soit, sans l'autorisation préalable et
          par écrit de &nbsp;<span class="s-t">Rémi Thanwerdas </span>et/ou de
          ses partenaires est strictement interdite et serait susceptible de
          constituer une contrefaçon au sens des articles L 335-2 et suivants du
          Code de la propriété intellectuelle.
        </p>
        <p>
          L<span class="calibre2">a</span> marque
          <span class="s-t">1Exo est une marque déposée</span> par
          <span class="calibre2">Rémi Thanwerdas</span>. Toute représentation
        ...
        <h2 class="subtitle has-text-tertiary is-3">Liens hypertextes</h2>
        <p>
          Le site <span class="s-t">www.1exo.fr </span>peut contenir des liens
          ...
          <span class="s-t">www.1exo.fr.</span>
        </p>
        <p>
          Il est possible de créer un lien vers la page de présentation de ce
          site sans autorisation expresse de l’EDITEUR. Aucune autorisation ou
          ...
          l’éditeur. Il convient toutefois d’afficher ce site dans une nouvelle
          fenêtre du navigateur. Cependant, l’EDITEUR se réserve le droit de
          demander la suppression d’un lien qu’il estime non conforme à l’objet
          du site
          <span class="s-t">www.1exo.fr.</span>
        </p>
        <h2 class="subtitle has-text-tertiary is-3">
        ...
        <p>
          L’EDITEUR se réserve le droit de les corriger, dès que ces erreurs
          sont portées à sa connaissance.
        </p>
        <p>
          Il est fortement recommandé de vérifier l’exactitude et la pertinence
          des informations et/ou documents mis à disposition sur ce site.
        </p>
        <p>
        ...
        <p>
          ...
          l’EDITEUR puisse être recherché à ce titre, et sans recours contre ce
          dernier.
        </p>
        <p>
          L’EDITEUR ne pourra en aucun cas être tenu responsable de tout dommage
          de quelque nature qu’il soit résultant de l’interprétation ou de
          l’utilisation des informations et/ou documents disponibles sur ce
          site.
        </p>
        <h2 class="subtitle has-text-tertiary is-3">Accès au site</h2>
        <p>
          L’éditeur s’efforce de permettre l’accès au site 24 heures sur 24, 7
          jours sur 7, sauf en cas de force majeure ou d’un événement hors du
          contrôle de l’EDITEUR, et sous réserve des éventuelles pannes et
          interventions de maintenance nécessaires au bon fonctionnement du site
          et des services.
        </p>
        <p>
          Par conséquent, l’EDITEUR ne peut garantir une disponibilité du site
          et/ou des services, une fiabilité des transmissions et des
          performances en terme de temps de réponse ou de qualité. Il n’est
        ...
        <p>
          Par ailleurs, l’EDITEUR peut être amené à interrompre le site ou une
          partie des services, à tout moment sans préavis, le tout sans droit à
          indemnités. L’utilisateur reconnaît et accepte que l’EDITEUR ne soit
          pas responsable des interruptions, et des conséquences qui peuvent en
        ...
        <p>
          L’EDITEUR se réserve la possibilité de modifier, à tout moment et sans
          préavis, les présentes conditions d’utilisation afin de les adapter
          aux évolutions du site et/ou de son exploitation.
        </p>
        <h2 class="subtitle has-text-tertiary is-3">
        ...
        <p>
          L’EDITEUR n’assume aucune responsabilité sur les services accessibles
          par Internet et n’exerce aucun contrôle de quelque forme que ce soit
          sur la nature et les caractéristiques des données qui pourraient
          transiter par l’intermédiaire de son centre serveur.
        </p>
        <p>
          ...
          présence du logo 1Exo institue une présomption simple de validité. La
        ...
        <p>
          L’utilisateur reconnaît que l’EDITEUR ne dispose d’aucun moyen de
          contrôle sur le contenu des services accessibles sur Internet
        </p>
        <h2 class="subtitle has-text-tertiary is-3">Droit applicable</h2>
        <p>
        ...
        <p>
          ...
          site, vous pouvez nous écrire à l’adresse suivante :
        </p>
        <p>support@1exo.fr</p>
      </div>
    </div>
