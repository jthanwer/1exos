      ...
      <div class="media">
        ...
        <div class="media-content">
          <p v-if="exo.livre" class="title is-4">
            ...
            {{ exo.type }} {{ exo.num_exo }} - Page {{ exo.num_page }} - Sur
            livre - {{ classes[exo.posteur.classe] }}
          </p>
          <p v-else class="title is-4">
            <span class="title is-3 has-text-grey">{{ exo.id }}.</span>
            {{ exo.type }} {{ exo.id }} - Sur feuille -
            {{ classes[exo.posteur.classe] }}
          </p>
        ...
        <div class="media-right">
          <b-tag
            v-if="exo.corrections.length === 0 && !delai_depasse"
            type="is-success"
            size="is-medium"
          >
            {{ exo.prix }} pts
          ...
          <b-tag
            v-else-if="exo.corrections.length === 0 && delai_depasse"
            type="is-success"
            size="is-medium"
          >
            1 pts
      ...
      <div class="level">
        <div class="level-left">
          <div class="level-item">
            ...
            <b-tag v-else type="is-success" size="is-medium">
              Corrigé
            </b-tag>
          </div>
        </div>
...
export default {
  ...
  computed: {
    has_correc() {
      return this.exo.corrections.length !== 0;
    },
    delai() {
      let date1 = moment();
