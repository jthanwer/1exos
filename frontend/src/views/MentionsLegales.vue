    ...
    <div class="container">
      <div class="content">
        ...
        <p>
          ...
          du site <a href="http://1exo.fr/">1exo.fr</a> l'identité des
        ...
        <p>
          ...
          <a href="http://1exo.fr/">1exo.fr</a> sont donc invités à les
        ...
        <p>
          ...
          <a href="http://1exo.fr/">1exo.fr</a> sont données à titre indicatif,
          et sont susceptibles d’évoluer. Par ailleurs, les renseignements
          figurant sur le site <a href="http://1exo.fr/">1exo.fr</a> ne sont pas
        ...
        <p>
          Rémi Thanwerdas est propriétaire des droits de propriété
        ...
        <p>
          Rémi Thanwerdas ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site 1exo.fr, et résultant soit de l’utilisation d’un matériel ne
          répondant pas aux spécifications indiquées au point 4, soit de
          l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          Rémi Thanwerdas ne pourra également être tenue responsable des
        ...
        <p>
          ...
          <a href="http://1exo.fr/">1exo.fr</a>, peuvent êtres recueillies :
          l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au
          site <a href="http://1exo.fr/">1exo.fr</a>, le fournisseur d'accès de
        ...
        <p>
          ...
          <a href="http://1exo.fr/">1exo.fr</a> l’obligation ou non de fournir
          ces informations.
        </p>
        <p>
        ...
        <p>
          ...
          l'utilisateur du site <a href="http://1exo.fr/">1exo.fr</a>.
        </p>
        <p>
        ...
        <p>
          Le site <a href="http://1exo.fr/">1exo.fr</a> contient un certain
          nombre de liens hypertextes vers d’autres sites, mis en place avec
          l’autorisation de Rémi Thanwerdas. Cependant, Rémi Thanwerdas n’a pas
