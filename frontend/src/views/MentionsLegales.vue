<template>
  <div class="container">
    <div class="content">
      ...
      <h2 class="subtitle has-text-tertiary">1. Présentation du site.</h2>
      <p>
      ...
      <p>
        ...
        <a href="https://www.researchgate.net/profile/Joel_Thanwerdas"
          >Joël Thanwerdas</a
        ><br />
        <strong>Responsable publication</strong> : Rémi Thanwerdas –
        0633377116<br />
        ...
        <strong>Crédits</strong> : Joël Thanwerdas - Rémi Thanwerdas<br />
      ...
      <p>
        ...
        <a href="http://1exo.fr/">1exo.fr</a> sont donc invités à les consulter
      ...
      <p>
        Le site <a href="http://1exo.fr/">1exo.fr</a> est mis à jour
        régulièrement par Rémi Thanwerdas. De la même façon, les mentions
      ...
      <p>
        Le site <a href="http://1exo.fr/">1exo.fr</a> a pour objet de fournir
        une information concernant l’ensemble des activités de la société.
      </p>
      <p>
        Rémi Thanwerdas s’efforce de fournir sur le site
        <a href="http://1exo.fr/">1exo.fr</a> des informations aussi précises
      ...
      <p>
        ...
        sur le site <a href="http://1exo.fr/">1exo.fr</a> ne sont pas
      ...
      <p>
        Rémi Thanwerdas est propriétaire des droits de propriété intellectuelle
      ...
      <p>
        ...
        1exo.fr, et résultant soit de l’utilisation d’un matériel ne répondant
        pas aux spécifications indiquées au point 4, soit de l’apparition d’un
      ...
      <p>
        ...
        <a href="http://1exo.fr/">1exo.fr</a>.
      </p>
      <p>
        Des espaces interactifs (possibilité de poser des questions dans
        l’espace contact) sont à la disposition des utilisateurs. Rémi
        Thanwerdas se réserve le droit de supprimer, sans mise en demeure
        ...
        relatives à la protection des données. Le cas échéant, Rémi Thanwerdas
      ...
      <p>
        ...
        quelconque à des tiers. Seule l'hypothèse du rachat de Rémi Thanwerdas
        ...
        du site <a href="http://1exo.fr/">1exo.fr</a>.
      </p>
      <p>
      ...
      <p>
        ...
        l’autorisation de Rémi Thanwerdas. Cependant, Rémi Thanwerdas n’a pas la
      ...
      <p>
        ...
        <a href="http://1exo.fr/">1exo.fr</a> est soumis au droit français. Il
      ...
      <h2 class="subtitle has-text-tertiary">11. Lexique.</h2>
