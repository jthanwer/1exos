<template>
  <div class="card">
    <div class="card-content">
      <div class="media">
        <div v-if="!unlocked" class="media-left pa-1 has-background-warning">
          <b-icon icon="lock"></b-icon>
        </div>
        <div v-else class="media-left pa-1 has-background-success">
          <b-icon icon="lock-open"></b-icon>
        </div>
        <div class="media-content">
          <div class="subtitle is-size-6">
            <p>
              Posté par <strong>{{ correc.enonce.posteur.username }}</strong> le
