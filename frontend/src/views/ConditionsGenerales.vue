<template>
  <div class="container">
    ...
    <h2 class="subtitle">1. Présentation du site.</h2>
    <p>
      En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
      confiance dans l'économie numérique, il est précisé aux utilisateurs du
      site <a href="http://1exo.fr/">1exo.fr</a> l'identité des différents
      intervenants dans le cadre de sa réalisation et de son suivi :
    </p>
    <p>
      <strong>Propriétaire</strong> : Rémi Thanwerdas – Micro-entreprise
      83789781800014 – 29 Impasse Catonne, 46000 CAHORS<br />
      <strong>Créateur</strong> :
      <a href="https://www.researchgate.net/profile/Joel_Thanwerdas"
        >Joël Thanwerdas</a
      ><br />
      <strong>Responsable publication</strong> : Rémi Thanwerdas – 0633377116<br />
      Le responsable publication est une personne physique ou une personne
      morale.<br />
      <strong>Webmaster</strong> : Joël Thanwerdas –
      joel.thanwerdas@gmail.com<br />
      <strong>Hébergeur</strong> : PlanetHoster – PlanetHoster 4416
      Louis-B.-Mayer Laval, Québec Canada H7P 0G1<br />
      Crédits : Joël Thanwerdas Rémi Thanwerdas<br />
      ...
      <a
        ...
        alt="Modèle de mentions légales"
        >Modèle de mentions légales</a
      >
    </p>
    ...
    <p>
      L’utilisation du site <a href="http://1exo.fr/">1exo.fr</a> implique
      ...
      <a href="http://1exo.fr/">1exo.fr</a> sont donc invités à les consulter de
      manière régulière.
    </p>
    <p>
      ...
      décidée par Rémi Thanwerdas, qui s’efforcera alors de communiquer
      préalablement aux utilisateurs les dates et heures de l’intervention.
    </p>
    <p>
      Le site <a href="http://1exo.fr/">1exo.fr</a> est mis à jour régulièrement
      par Rémi Thanwerdas. De la même façon, les mentions légales peuvent être
    ...
    <h2 class="subtitle">3. Description des services fournis.</h2>
    <p>
      Le site <a href="http://1exo.fr/">1exo.fr</a> a pour objet de fournir une
      information concernant l’ensemble des activités de la société.
    </p>
    <p>
      Rémi Thanwerdas s’efforce de fournir sur le site
      <a href="http://1exo.fr/">1exo.fr</a> des informations aussi précises que
      possible. Toutefois, il ne pourra être tenue responsable des omissions,
    ...
    <p>
      ...
      <a href="http://1exo.fr/">1exo.fr</a> sont données à titre indicatif, et
      sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur
      le site <a href="http://1exo.fr/">1exo.fr</a> ne sont pas exhaustifs. Ils
      sont donnés sous réserve de modifications ayant été apportées depuis leur
      mise en ligne.
    </p>
    <h2 class="subtitle">
    ...
    <h2 class="subtitle">5. Propriété intellectuelle et contrefaçons.</h2>
    <p>
      Rémi Thanwerdas est propriétaire des droits de propriété intellectuelle ou
    ...
    <h2 class="subtitle">6. Limitations de responsabilité.</h2>
    <p>
      Rémi Thanwerdas ne pourra être tenue responsable des dommages directs et
      indirects causés au matériel de l’utilisateur, lors de l’accès au site
      1exo.fr, et résultant soit de l’utilisation d’un matériel ne répondant pas
      aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou
      d’une incompatibilité.
    </p>
    <p>
      Rémi Thanwerdas ne pourra également être tenue responsable des dommages
      indirects (tels par exemple qu’une perte de marché ou perte d’une chance)
      consécutifs à l’utilisation du site <a href="http://1exo.fr/">1exo.fr</a>.
    </p>
    <p>
      Des espaces interactifs (possibilité de poser des questions dans l’espace
      contact) sont à la disposition des utilisateurs. Rémi Thanwerdas se
      ...
      protection des données. Le cas échéant, Rémi Thanwerdas se réserve
    ...
    <h2 class="subtitle">7. Gestion des données personnelles.</h2>
    <p>
    ...
    <p>
      ...
      <a href="http://1exo.fr/">1exo.fr</a>, peuvent êtres recueillies : l'URL
      des liens par l'intermédiaire desquels l'utilisateur a accédé au site
      <a href="http://1exo.fr/">1exo.fr</a>, le fournisseur d'accès de
      l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.
    </p>
    <p>
      En tout état de cause Rémi Thanwerdas ne collecte des informations
      personnelles relatives à l'utilisateur que pour le besoin de certains
      services proposés par le site <a href="http://1exo.fr/">1exo.fr</a>.
      ...
      <a href="http://1exo.fr/">1exo.fr</a> l’obligation ou non de fournir ces
      informations.
    </p>
    <p>
    ...
    <p>
      ...
      <a href="http://1exo.fr/">1exo.fr</a> n'est publiée à l'insu de
      l'utilisateur, échangée, transférée, cédée ou vendue sur un support
      quelconque à des tiers. Seule l'hypothèse du rachat de Rémi Thanwerdas et
      de ses droits permettrait la transmission des dites informations à
      ...
      site <a href="http://1exo.fr/">1exo.fr</a>.
    </p>
    <p>
    ...
    <h2 class="subtitle">8. Liens hypertextes et cookies.</h2>
    <p>
      Le site <a href="http://1exo.fr/">1exo.fr</a> contient un certain nombre
      de liens hypertextes vers d’autres sites, mis en place avec l’autorisation
      de Rémi Thanwerdas. Cependant, Rémi Thanwerdas n’a pas la possibilité de
      vérifier le contenu des sites ainsi visités, et n’assumera en conséquence
      aucune responsabilité de ce fait.
    </p>
    <p>
      La navigation sur le site <a href="http://1exo.fr/">1exo.fr</a> est
    ...
    <h2 class="subtitle">9. Droit applicable et attribution de juridiction.</h2>
    <p>
      Tout litige en relation avec l’utilisation du site
      <a href="http://1exo.fr/">1exo.fr</a> est soumis au droit français. Il est
      fait attribution exclusive de juridiction aux tribunaux compétents de
      Paris.
    </p>
    <h2 class="subtitle">10. Les principales lois concernées.</h2>
    <p>
    ...
    <h2 class="subtitle">11. Lexique.</h2>
